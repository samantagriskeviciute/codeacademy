...
$f=(bool)1; //tipo cast, pabandom paskelbti kitu tipu
var_dump($f);

$int_a=0x10; //hex decm integer
echo $int_a. "<br>"; //isvedimas i tinklapi
...
//$o_2=new class{}; //objekto sukurimas naujausia versija
